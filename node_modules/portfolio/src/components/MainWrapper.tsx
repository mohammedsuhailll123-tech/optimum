      ...
      {!loading && (
        <div className="relative w-full min-h-screen bg-canvas-soft text-ink transition-colors duration-300">
          ...
          <main className="w-full">
            <ThreeDHero currentLang={lang} onRequestQuote={() => setIsQuoteOpen(true)} />
            <AboutSection currentLang={lang} />
            <ProductShowcase currentLang={lang} onRequestQuote={() => setIsQuoteOpen(true)} />
          ...
          {/* Sourcing RFQ Quote Popup Modal */}
          <QuoteModal 
            isOpen={isQuoteOpen} 
