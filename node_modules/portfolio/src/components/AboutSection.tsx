...
import { Target, Compass, Sparkles, Zap, Award, Smile, ShieldAlert, HeartHandshake, Eye } from 'lucide-react';
    ...
    <section id="about" className="py-24 bg-canvas border-t border-glass-border select-none overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
            ...
            {activeTab === 'values' && (
              ...
              >
                {[
                  ...
                  { key: 'integrity', title: t.values.integrity, desc: t.values.integrityDesc, color: 'border-l-accent-cyan' },
                  { key: 'innovation', title: t.values.innovation, desc: t.values.innovationDesc, color: 'border-l-purple-500' },
                  { key: 'safety', title: t.values.safety, desc: t.values.safetyDesc, color: 'border-l-pink-500' },
                  { key: 'reliability', title: t.values.reliability, desc: t.values.reliabilityDesc, color: 'border-l-emerald-500' },
                  { key: 'professionalism', title: t.values.professionalism, desc: t.values.professionalismDesc, color: 'border-l-yellow-500' },
                  { key: 'customer', title: t.values.customer, desc: t.values.customerDesc, color: 'border-l-indigo-500' },
                  { key: 'excellence', title: t.values.excellence, desc: t.values.excellenceDesc, color: 'border-l-red-500' }
                ].map((val) => (
                  <div 
                    key={val.key} 
                    className={`p-5 glass-panel rounded-xl flex flex-col justify-between border-l-2 ${val.color} h-40 hover:-translate-y-1 transition-transform duration-300`}
                  >
                    <span className="text-[9px] font-mono text-mute select-none uppercase tracking-wider">VALUE</span>
                    <div>
                      <h4 className="text-xs font-extrabold text-ink mb-1">{val.title}</h4>
                      <p className="text-[10px] text-body leading-relaxed">{val.desc}</p>
                    </div>
                  </div>
                ))}
              </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          ...
          {/* Card 3: Custom Sourcing Schedulers */}
          <div 
            onMouseMove={handleMouseMove}
            className="glow-card p-6 glass-panel rounded-2xl flex gap-4 cursor-default group"
          >
