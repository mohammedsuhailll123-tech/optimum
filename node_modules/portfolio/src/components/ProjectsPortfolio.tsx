...
export const ProjectsPortfolio: React.FC<ProjectsPortfolioProps> = ({ currentLang: initialLang }) => {
  ...
  const categories = [
    ...
    { id: 'oilGas', label: t.categories.oilGas },
    { id: 'petro', label: t.categories.petro },
    { id: 'power', label: t.categories.power },
    { id: 'construction', label: t.categories.construction },
    { id: 'marine', label: t.categories.marine }
  ];
        ...
        <div className="flex flex-wrap justify-center gap-2 mb-12 max-w-5xl mx-auto">
          {categories.map((cat) => (
            <button
              ...
              className={`px-4 py-2 rounded-full text-xs font-semibold tracking-wider transition-all focus:outline-none border ${activeCategory === cat.id
